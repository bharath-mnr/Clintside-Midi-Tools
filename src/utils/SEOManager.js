...
export const pageData = {
  'home': {
    ...
    description: 'Complete MIDI toolkit with 20+ tools including Text to MIDI converter, MIDI to Text converter, Audio to MIDI converter and more. Fast, secure, and free online MIDI processing.',
    keywords: 'MIDI converter, MIDI tools, Text to MIDI, MIDI to Text, Audio to MIDI, online MIDI tools'
  },
  'text-midi-converter': {
  ...
  'audio-midi-converter': {
    title: 'Audio to MIDI Converter - Convert Audio Files to MIDI Online',
    description: 'Convert audio files (MP3, WAV, etc.) to MIDI format online. Free and accurate audio to MIDI converter for musicians and producers.', 
    keywords: 'Audio to MIDI, MIDI converter, online MIDI conversion, audio conversion'
  },
